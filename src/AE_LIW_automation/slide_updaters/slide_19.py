...
def slide_19_updater(meta, df, df_labeled, prs):
    ...
    #
    #     subbed_df[question] = df_labeled[question].astype(str).replace(label_sub_dict)
    #
    #     # current_quarter_result_series: Series = df_labeled[question].value_counts()
    #     current_quarter_result_series: Series = subbed_df[question].value_counts()
    #
    #     if current_quarter_result_series.empty:
    #         continue
    #
    #     if current_quarter_result is None:
    #         current_quarter_result = current_quarter_result_series
    #     else:
