# slide_30.py
# This file contains the functions for updating slide 30 of the Powerpoint file
...
def slide_30_updater(df, prs) -> object:
    print('updating slide 30')
    slide_index = 29
    ...
    current_quarter_chart_data = df['Q8'].value_counts(normalize=True).sort_index()
